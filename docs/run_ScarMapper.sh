...
python3 /mnt/hgfs/OneDrive_UNC/Projects/ScarMapper/scarmapper.py --options_file /mnt/hgfs/OneDrive_UNC/Projects/ScarMapper/docs/run_ScarMapper.sh
exit
...
--Index_File	/mnt/hgfs/OneDrive_UNC/Projects/ScarMapper/docs/Ramsden_Index2.bed
# --Index_File	/mnt/hgfs/OneDrive_UNC/Projects/ScarMapper/docs/TestIndex.bed
--Target_File	/mnt/hgfs/OneDrive_UNC/Projects/ScarMapper/docs/ScarMapper_Targets.txt
# --Working_Folder	/mnt/hgfs/OneDrive_UNC/Projects/ScarMapper/Testing2/
# --Working_Folder	/mnt/hgfs/D_Drive/ScarMapper_Testing/
